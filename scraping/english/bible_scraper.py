...
class BibleScraper:
    ...
    def __init__(self, output_dir: str = "../../versions/en", progress_file: str = "scraper_progress.json"):
...
def main():
    ...
    parser.add_argument(
        '--output-dir', '-o',
        default='../../versions/en',
        help='Output directory for translation JSON files (default: ../../versions/en, relative to script location)'
    )
    parser.add_argument(
        '--resume', '-r',
        action='store_true',
    ...
    # Create scraper
    scraper = BibleScraper(output_dir=args.output_dir)
